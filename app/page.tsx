    ...
    <>
      <section>  
        ...
        <p className="mb-2">
          ...
          studying bacteria in isolation helps us embrace the complexity of microbial life. I'm fascinated by the emergent patterns that appear when microbes form the diverse and vibrant communities we observe in nature. 
          Correspondingly, the goal of my research is to uncover the hidden patterns that drive microbial behavior in communities and translate that understanding
